<template>
  <div class="app-container">
    ...
    <el-table ref="multipleTable" v-loading="loading" :data="commodityList">
      ...
      <el-table-column label="公司名称" align="center" prop="gsskzhname">
        <template slot-scope="scope">
          {{ scope.row.gsskzhname }}
        </template>
      </el-table-column>
      <el-table-column label="公司收款商户号" align="center" prop="gsskshh">
      </el-table-column>
      <el-table-column label="公司收款银行名称" align="center" prop="gsskyhmc">
      </el-table-column>
      <el-table-column label="公司收款账户" align="center" prop="gsskzh">
      </el-table-column>
